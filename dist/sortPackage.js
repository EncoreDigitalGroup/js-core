...
exports.__sortPackageJson = __sortPackageJson;
exports.__sortPackageFile = __sortPackageFile;
const package_1 = require("./formatters/package");
const types_1 = require("./shared/types");
const fs_1 = __importDefault(require("fs"));
const path_1 = __importDefault(require("path"));
const sort_package_json_1 = require("sort-package-json");
function __sortPackageJson(packageObj, options = {}) {
    ...
    if (sortedPackage.exports) {
        sortedPackage.exports = (0, package_1.__sortExportsKeys)(sortedPackage.exports);
    }
    return sortedPackage;
}
function __sortPackageFile(filePath, options = {}) {
